...
import '../../perent_profile_screen/widget/kids_widget_list.dart';
import '../controller/driver_profile_controller.dart';

class DriverScreenWidget extends StatelessWidget {
  const DriverScreenWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: DriverProfileController(),
      builder: (DriverProfileController controller) => Column(
        children: [
          Row(
