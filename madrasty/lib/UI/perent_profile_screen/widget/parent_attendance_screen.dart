    ...
    return GetBuilder(
      ...
      builder: (PerentProfileController controller) => Column(
        children: [
          ...
          controller.attendanceTable?.isEmpty??true?const SizedBox():controller.isAttendanceTableLoading?Center(child: Loader(width: Get.width*0.9,height: Get.height*0.4,)):controller.attendanceTable?.isEmpty??true?NoDataWidget(
