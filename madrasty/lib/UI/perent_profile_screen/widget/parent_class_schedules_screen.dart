...
class ParentClassSchedulesScreen extends StatelessWidget {
  const ParentClassSchedulesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: PerentProfileController(),
      builder: (PerentProfileController controller) => SingleChildScrollView(
