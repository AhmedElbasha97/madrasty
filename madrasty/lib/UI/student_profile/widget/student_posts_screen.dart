                      ...
                      Container(
                          ...
                          PlatformRefreshIndicator(
                              ...
                              itemBuilder: (context, index) =>
                                  Column(
                                    children: [
                                      PostWidget(postDataFromScreen:  controller.postsListData?[index], schoolId: "${controller.schoolId?.school??0}", classId:  "${controller.schoolId?.schoolIdModelClass??0}",peopleSareList: controller.peopleShareList,),
