...
class AttendanceTableWidgetScreen extends StatelessWidget {
  const AttendanceTableWidgetScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: SupervisorProfileController(),
      builder: (SupervisorProfileController controller) =>
                        ...
                        DataRow(cells: [
                            ...
                            InkWell(
                              onTap: (){
                                if((controller.attendanceTable?[index].check??0)==1){
                                  controller.selectingArrivalTime( context, index);
                                }
                              },
                          ...
                          DataCell(
                            InkWell(
                              onTap: (){
                                if((controller.attendanceTable?[index].check??0)==1){
                                  controller.selectingLeaveTime( context,index);
                                }
                              },
                              child: CustomText(
                                textAlign: TextAlign.center,
