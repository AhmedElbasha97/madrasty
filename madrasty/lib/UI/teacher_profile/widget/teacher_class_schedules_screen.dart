...
class TeacherClassSchedulesScreen extends StatelessWidget {
  const TeacherClassSchedulesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: TeacherProfileController(),
      builder: (TeacherProfileController controller) => SingleChildScrollView(
