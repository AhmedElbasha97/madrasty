// ignore_for_file: unused_local_variable, unnecessary_null_comparison, deprecated_member_use, prefer_typing_uninitialized_variables, constant_identifier_names
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    const colorClickableText =kDarkBlueColor;
