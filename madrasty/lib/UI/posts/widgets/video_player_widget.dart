...
import 'package:madrasty/UI/posts/widgets/video_fullscreen_widget.dart';
...
import '../../chat/message_list/widget/image_chatting_cell.dart';

class VideoPlayerWidget extends StatefulWidget {
  final VideoPlayerController videoPlayerController;
  final String videoPlayer;
  const VideoPlayerWidget({super.key, required this.videoPlayer, required this.videoPlayerController});
