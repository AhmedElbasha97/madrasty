...
class VideoShowWidget extends StatefulWidget {
  ...
  const VideoShowWidget({super.key,  required this.videoPlayerController,required this.chooseAnotherVideo,required this.schoolId,required this.classId});

  @override
  State<VideoShowWidget> createState() => _VideoPlayerWidgetState();
}

class _VideoPlayerWidgetState extends State<VideoShowWidget> {
  ...
  Widget build(BuildContext context) {
    return  GetBuilder(
        init: AddPostController(widget
        .schoolId??"",widget.classId??""),
        builder: (AddPostController controller) =>  Stack(
        children: [
          Padding(
                                ...
                                child: Center(
                                  child: Row(
                                    children: [  IconButton(onPressed: (){
                                        ...
                                        child:ClipRRect(
                                          ...
                                          child: VideoProgressIndicator(
                                            ...
                                            colors:  VideoProgressColors(
                                                ...
                                                backgroundColor: kDarkBlueColor.withValues(alpha:0.5),
                                                bufferedColor:kDarkBlueColor.withValues(alpha:0.5),
                                      ...
                                      }, icon:  widget.videoPlayerController.value.volume == 0.0?const Icon(Icons.volume_mute,color: Colors.white,):const Icon(Icons.volume_up,color: Colors.white,)),
                                      Text(
