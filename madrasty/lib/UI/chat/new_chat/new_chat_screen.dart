...
import 'package:madrasty/UI/chat/chat_history/message_screens.dart';
...
import '../chat_history/widget/loading_chat_list_widget.dart';
import 'controller/new_chat_controller.dart';
import 'widget/new_chat_cell_widget.dart';
...
class NewChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (NewChatController controller) =>controller.showHistoryChatScreen? const MessageScreens(): SizedBox(
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 5,),
                    controller.chatHistoryIsLoading?LoadingChatListWidget():controller.isSearchActive?controller.searchedNewChatList?.isEmpty??false?Column(
                      ...
                      children: [
                        ...
                        :Column(
                      children: controller.searchedNewChatList!.map((e){
                        return  NewChatCellWidget(press: () async {
                          controller.goToMessageScreen(e.type??"", "${e.id??0}",e.name??"");

                        },chat: e,);
                      }).toList(),
                    ):controller.isFilterActive?controller.filteredNewChatList?.isEmpty??false?
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                      ...
                      children: controller.filteredNewChatList!.map((e){
                        return  NewChatCellWidget(press: () async {
                          controller.goToMessageScreen(e.type??"", "${e.id??0}",e.name??"");
                      ...
                      children: controller.newChatList!.map((e){
                        return  NewChatCellWidget(press: () async {
                          controller.goToMessageScreen(e.type??"", "${e.id??0}",e.name??"");
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          controller.showingHistoryScreenChat();
                        },
                        child: Container(
                          width: Get.width*0.17,
                          height: Get.height*0.08,
