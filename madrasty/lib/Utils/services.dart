...
static String forgettingPasswordEndPoint = "change_password_otp"; //Post
...
static String deletingAccountEndPoint = "delete_user";//Post
...
static String reportingPostEndPoint = "post_report";//Post
static String getPostStatusEndPoint = "post_perm";//Post
static String getFileStatusEndPoint = "file_check";//Post
...
static String getSocialMediaLinksEndPoint = "social";//Post
